...
/*
 ...
 /// Google Models
 OpenRouterModel(name: "Gemini 2.5 Flash Image Preview", provider: .google, description: "Gemini 2.5 Flash Image Preview is a state of the art image generation model with contextual understanding. It is capable of image generation, edits, and multi-turn conversations.", code: "google/gemini-2.5-flash-image-preview"),
